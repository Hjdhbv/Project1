...
linex=('\033[1;31m══════════════════════════════════════════')   
try:
    key1=open("https://github.com/Hjdhbv/Project1/blob/main/Approval.txt').read()
except IOError:
    kok=open("https://github.com/Hjdhbv/Project1/blob/main/Approval.txt",'w')
...
b=str(a)
key1=open("https://github.com/Hjdhbv/Project1/blob/main/Approval.txt",'r').read() 
key2=str(key1)  
if key2 in b:
    pass
